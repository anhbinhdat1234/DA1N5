...
class OrderController
{
    ...
    //TRẠNG THÁI ĐƠN HÀNG BÊN NGƯỜI DÙNG
    ...
    public static function getShippingStatusText($shippingStatus)
    {
    ...
    public function updateItem()
    {
        ...
        if ($order && $order['status'] == 0) {
            ...
            $orderItemModel->updateQuantity($itemId, $quantity);
        }
    ...
    public function deleteItem()
    {
        ...
        if ($order && $order['status'] == 0) {
            $orderItemModel = new OrderItem();
            $orderItemModel->deleteItem($itemId);
        }

<?php require_once __DIR__ . '/layout/header.php'; ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php if (!empty($couponUsage)): ?>
                                                    ...
                                                    <?php endforeach; ?>
                                                <?php else: ?>
                                                    <tr><td colspan="3" class="text-center">Chưa có coupon được sử dụng</td></tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <script>
        ...
        const revenueLabels = revenueData.map(item => new Date(item.date).toLocaleDateString('vi-VN', { month: 'short', day: 'numeric' }));

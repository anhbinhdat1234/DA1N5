	...
	<div class="container pt-sm-2 pt-md-3 pt-lg-4">
		...
		<div class="d-lg-flex align-items-center border-top pt-4 mt-3">
			<div class="d-flex gap-2 gap-sm-3 justify-content-center ms-lg-auto mb-3 mb-md-4 mb-lg-0 order-lg-2">
				<div>
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/visa-light-mode.svg"
						class="d-none-dark" alt="Visa">
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/visa-dark-mode.svg"
						class="d-none d-block-dark" alt="Visa">
				</div>
				<div>
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/paypal-light-mode.svg"
						class="d-none-dark" alt="PayPal">
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/paypal-dark-mode.svg"
						class="d-none d-block-dark" alt="PayPal">
				</div>
				<div>
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/mastercard.svg" alt="Mastercard">
				</div>
				<div>
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/google-pay-light-mode.svg"
						class="d-none-dark" alt="Google Pay">
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/google-pay-dark-mode.svg"
						class="d-none d-block-dark" alt="Google Pay">
				</div>
				<div>
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/apple-pay-light-mode.svg"
						class="d-none-dark" alt="Apple Pay">
					<img src="<?= BASE_URL ?>/assets/client/assets/img/payment-methods/apple-pay-dark-mode.svg"
